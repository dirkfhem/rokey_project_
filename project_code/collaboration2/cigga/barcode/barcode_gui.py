...
BEEP_PATH = "/home/minsuje/ros2_ws/barcode/qrbarcode_beep.mp3"
XLS_PATH = "/home/minsuje/ros2_ws/barcode/cigarette_barcode.xls"
SALES_CSV_PATH = "/home/minsuje/ros2_ws/barcode/sales_history.csv"
SCAN_COOLDOWN = 2
CAM_NUM = 0
...
class MainGUI:
    def __init__(self, root):
        ...
        self.root.bind('<Control-Shift-A>', lambda event: self.open_scan())  # Ctrl+Shift+A로 바코드 화면 전환
        
    def open_scan(self):
        self.root.withdraw()  # 메인 화면 숨기기
        scan_window = tk.Toplevel(self.root)
        SalesGUI(scan_window, self.root)
...
class SalesGUI:
    def __init__(self, root, main_root):
        ...
        self.scanner = BarcodeScanner(self, XLS_PATH)
    ...
    def confirm_order(self):
        ...
        print(f"주문 확인 결과: {confirm}")  # True/False 출력
