...
#ifndef CUSTOM_PKG_SRV_TEST__SRV__DETAIL__CUSTOM_SERVICE__FUNCTIONS_H_
#define CUSTOM_PKG_SRV_TEST__SRV__DETAIL__CUSTOM_SERVICE__FUNCTIONS_H_
...
#include "custom_pkg_srv_test/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_pkg_srv_test
bool
 ...
 * calls
 * custom_pkg_srv_test__srv__CustomService_Request__init().
...
/**
 * It calls
 * custom_pkg_srv_test__srv__CustomService_Request__fini()
 ...
 * custom_pkg_srv_test__srv__CustomService_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * custom_pkg_srv_test__srv__CustomService_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_pkg_srv_test__srv__CustomService_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_pkg_srv_test
...
/**
 * It calls
 * custom_pkg_srv_test__srv__CustomService_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_pkg_srv_test
...
/**
 * It allocates the memory for the array and calls
 * custom_pkg_srv_test__srv__CustomService_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_pkg_srv_test
...
/**
 * It calls
 * custom_pkg_srv_test__srv__CustomService_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CUSTOM_PKG_SRV_TEST__SRV__DETAIL__CUSTOM_SERVICE__FUNCTIONS_H_
